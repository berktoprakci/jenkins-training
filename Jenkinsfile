pipeline {
    ...
    post {
        ...
        success {
            ...
            octopusDeployRelease deploymentTimeout: '', environment: 'Production', project: 'jenkins-training', releaseVersion: '0.0.43', serverId: 'cloudOcto', spaceId: 'Spaces-1', tenant: '', tenantTag: '', toolId: 'Default', variables: ''
        }
    }
}